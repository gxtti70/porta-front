...
export default function Home({ projects, loading }: HomeProps) {
  return (
    <div className="min-h-screen bg-[#111827] text-zinc-100 font-sans selection:bg-cyan-500/30 overflow-x-hidden">
      ...
      {/* SECCIÓN: EXPERIENCIA LABORAL (LOGO TCS SVG + NEGRILLAS CORREGIDAS) */}
      ...
      <main className="max-w-6xl mx-auto px-6 pb-24">
        <div className="flex items-center gap-4 mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-white whitespace-nowrap">Proyectos</h2>
          <div className="h-[1px] w-full bg-zinc-800"></div>
        </div>
        {loading ? (
          <div className="text-zinc-500 font-mono animate-pulse">Sincronizando...</div>
        ) : (
